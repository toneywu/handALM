...
#actionMenuSidebar li a.side-bar-My_New_Icon {
    background-image: url("../../../../themes/MaterialDesignP/images/sidebar/side-bar-My_New_Icon.png");
    background-image: url("../../../../themes/MaterialDesignP/images/sidebar/side-bar-My_New_Icon.svg");
}