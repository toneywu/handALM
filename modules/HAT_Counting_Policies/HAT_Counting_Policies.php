 ...
 */
require_once('modules/HAT_Counting_Policies/HAT_Counting_Policies_sugar.php');
class HAT_Counting_Policies extends HAT_Counting_Policies_sugar {
	...
	function save($check_notify = FALSE){
        ...
        for ($i = 0; $i < $line_count; ++$i) {
        	$key="line_";
        	$lines = new HAT_Counting_Policy_Lines();
            if ($post_data[$key . 'deleted'][$i] == 1) {
	            ...
	            if (!$post_data['line_id'][$i]) {//新建才加关联关系
	            	...
	            	$relate_values = array(
            		'deleted' =>0 ,
	            	'hat_counti5649olicies_ida'=>$this->id,
	            	'hat_countifea6y_lines_idb'=>$lines->id 
	            	);
	            }
