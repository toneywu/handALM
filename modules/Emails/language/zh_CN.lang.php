...
$mod_strings = array (
    ...
    'LBL_EMAIL_DEFAULT_DESCRIPTION' 	=> '这是这是您请求的报价 (您可以改变这个文本)',
    'LBL_EMAIL_QUOTE_FOR' => '报价给',
    'LBL_QUOTE_LAYOUT_DOES_NOT_EXIST_ERROR' => '报价布局文件不存在: $layout',
    'LBL_QUOTE_LAYOUT_REGISTERED_ERROR' => '报价布局没在modules/Quotes/Layouts.php中注册',


	'LBL_CONFIRM_DELETE'		=> '您确实要删除这个文件夹吗?',
	'LBL_ENTER_FOLDER_NAME'		=> '请输入文件夹名称',

	'LBL_ERROR_SELECT_MODULE'   => '错误:请为相关字段选择一个模块',

	'ERR_ARCHIVE_EMAIL'			=> '错误:选择要存档的电子邮件',
	'ERR_DATE_START'			=> '错误:开始日期',
	'ERR_DELETE_RECORD'			=> '错误:必须指定记录编号才能删除客户。',
	...
	'LBL_ADD_FILE'				=> '添加文件',
	'LBL_ARCHIVED_EMAIL'		=> '已存档的邮件',
	'LBL_ARCHIVED_MODULE_NAME'	=> '新建存档邮件',
    'LBL_ARCHIVED_EMAILS_CREATE'  => '新建',
	'LBL_ATTACHMENTS'			=> '附件',
	...
	'LNK_NEW_CALL'				=> '记录电话',
	'LNK_NEW_EMAIL_TEMPLATE'	=> '新建电子邮件模板',
	'LNK_NEW_EMAIL'				=> '撰写邮件',
	...
	'LBL_BUTTON_CHECK_TITLE'	=> '接收邮件',
	'LBL_BUTTON_CHECK_KEY'		=> 'c',
	'LBL_BUTTON_FORWARD'		=> '转发',
	'LBL_BUTTON_FORWARD_TITLE'	=> '转发',
	...
	'LBL_CREATE_BUG'			=> '新建缺陷追踪',
	'LBL_CREATE_CASE'			=> '新建客户反馈',
	'LBL_CREATE_CONTACT'		=> '新建联系人',
	'LBL_CREATE_LEAD'			=> '新建潜在客户',
	'LBL_CREATE_TASK'			=> '新建任务',
	'LBL_DIST_TITLE'			=> '任务（LBL_DIST_TITLE）',
	'LBL_LOCK_FAIL_DESC'		=> '被选中的记录现在不可以被使用。',
	'LBL_LOCK_FAIL_USER'		=> '采取所有权。',
	'LBL_MASS_DELETE_ERROR'		=> '选中的条目未被删除。',
	'LBL_NEW'					=> '新建邮件',
	'LBL_NEXT_EMAIL'			=> '下一封邮件',
	'LBL_NO_GRAB_DESC'			=> '没有可使用的条目。稍后再试。',
	'LBL_QUICK_REPLY'			=> '回复',
	'LBL_REPLIED'				=> '已回复',
	'LBL_SELECT_TEAM'			=> '选择团队',
	'LBL_TAKE_ONE_TITLE'		=> '名（LBL_TAKE_ONE_TITLE）',
	'LBL_TITLE_SEARCH_RESULTS'	=> '查找结果',
	'LBL_TO'					=> '收件人',
	'LBL_TOGGLE_ALL'			=> '切换所有',
	'LBL_UNKNOWN'				=> '未知',
	'LBL_UNREAD_HOME'			=> '未读邮件',
	'LBL_UNREAD'				=> '未读',
	'LBL_USE_ALL'				=> '所有',
	'LBL_USE_CHECKED'			=> '已选中',
	'LBL_USE_MAILBOX_INFO'		=> '邮箱信息',
	'LBL_USE'					=> '指派（LBL_USE）',
	'LBL_ASSIGN_SELECTED_RESULTS_TO' => '指派选择结果给',
	...
	'LBL_LIST_TITLE_MY_ARCHIVES'=> '我的存档邮件',
    'LBL_ACTIVITIES_REPORTS' 	=> '活动报表',

	'LNK_CHECK_MY_INBOX'		=> '检查我的收件箱',
	'LNK_DATE_SENT'				=> '发送日期',
	...
	'LBL_EMAILTEMPLATE_MESSAGE_SHOW_TITLE' => '查看',
	...
	'LBL_FILTER_BY_RELATED_BEAN' => '只显示收件人相关的',
    'LBL_RECIPIENTS_HAVE_BEEN_ADDED' => '收件人已添加',
    'LBL_ADD_INBOUND_ACCOUNT' => '添加',
    'LBL_ADD_OUTBOUND_ACCOUNT' => '添加',
    'LBL_EMAIL_ACCOUNTS_INBOUND' => '收件箱',
    'LBL_EMAIL_SETTINGS_OUTBOUND_ACCOUNT' => '发件箱账户',
    'LBL_EMAIL_SETTINGS_OUTBOUND_ACCOUNTS' => '发件箱账户',
    'LBL_EMAIL_SETTINGS_INBOUND_ACCOUNTS' => '收件箱帐户',
    ...
    'LBL_ADD_CC_BCC_SEP' => '|',
    'LBL_SEND_EMAIL_FAIL_TITLE' => '电子邮件发送错误',
    ...
    'LBL_MAILBOX_TYPE_GROUP_FOLDER' => '组文件夹',
    'LBL_SEARCH_FOR' => '查找',
    ...
    'LBL_TEST_EMAIL_SUBJECT' => 'SugarCRM测试电子邮件',
    'LBL_NO_SUBJECT' =>'(无主题)',
	...
	'LBL_CREATE_BUGS' => '创建缺陷跟踪' /*for 508 compliance fix*/,
	...
	'LBL_CHECKEMAIL' => '接收邮件' /*for 508 compliance fix*/,
	'LBL_COMPOSEEMAIL' => '撰写邮件' /*for 508 compliance fix*/,
	'LBL_EMAILSETTINGS' => '邮箱设置' /*for 508 compliance fix*/,

	// SNIP
	'LBL_CONTACTS_SUBPANEL_TITLE_SNIP' => '联系人',
