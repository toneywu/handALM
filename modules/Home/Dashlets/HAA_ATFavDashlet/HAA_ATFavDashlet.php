...
class HAA_ATFavDashlet extends Dashlet {
     ...
     */
    function HAA_ATFavDashlet($id, $def) {
        $this->loadLanguage('HAA_ATFavDashlet'); // load the language strings here
    ...
    function display() {
        ...
        $ss->assign('AddNewAssetLBL', $this->dashletStrings['LBL_ADD_NEW_ASSETS']);
        $ss->assign('AssetListLBL', $this->dashletStrings['LBL_ASSET_LIST']);
        $ss->assign('ViewLocationLBL', $this->dashletStrings['LBL_VIEW_LOCATION']);
        $ss->assign('AssetTransLBL', $this->dashletStrings['LBL_ASSET_TRANSACTOIN']);
        $ss->assign('CountingLBL', $this->dashletStrings['LBL_COUNTING']);

        $str = $ss->fetch('modules/Home/Dashlets/HAA_ATFavDashlet/HAA_ATFavDashlet.tpl');
    ...
    function displayScript() {
        ...
        $str = $ss->fetch('modules/Home/Dashlets/HAA_ATFavDashlet/HAA_ATFavDashletScript.tpl');
    ...
    function displayOptions() {
        ...
        return parent::displayOptions() . $ss->fetch('modules/Home/Dashlets/HAA_ATFavDashlet/HAA_ATFavDashletOptions.tpl');
    }
