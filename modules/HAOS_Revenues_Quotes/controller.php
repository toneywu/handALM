...
class HAOS_Revenues_QuotesController extends SugarController {
    ...
    public function action_MassUpdate() {
        ...
        if($action=="MassUpdate"&&$delete_flag==true){
            ...
            foreach ($recordIds as $recordId) {
                $revenues_bean = BeanFactory::getBean("HAOS_Revenues_Quotes",$recordId);
                
                if($occur_error==0){
                    if($revenues_bean->clear_status=="Cleared"){
                        $occur_error=1;
                    }
                }
            }
