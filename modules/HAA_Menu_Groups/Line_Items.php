...
function display_lines($focus,$field,$value,$view){
	...
	if($view=='EditView'){
		...
		$html.="<table border='0'cellspacing='4' id='lineItems_menus'class='listviewtable table'></table>";
		...
		$html.='<script>insertLineHeader(\'lineItems_menus\');</script>';
		...
		$html.='<script>insertLineFootor(\'lineItems_menus\');</script>';
