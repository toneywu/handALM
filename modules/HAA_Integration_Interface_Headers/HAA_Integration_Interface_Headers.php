 ...
 */
require_once('modules/HAA_Integration_Interface_Headers/HAA_Integration_Interface_Headers_sugar.php');
class HAA_Integration_Interface_Headers extends HAA_Integration_Interface_Headers_sugar {
	...
	function save($check_notify = FALSE){
        ...
        for ($i = 0; $i < $line_count; ++$i) {
        	$lines = new HAA_Integration_Interface_Lines();
            if ($post_data[$key . 'deleted'][$i] == 1) {
                ...
                $lines->haa_integration_interface_headers_id_c=$this->id;
