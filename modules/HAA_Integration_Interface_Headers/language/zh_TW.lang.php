...
$mod_strings = array (
  ...
  'LBL_EDIT_BUTTON' => '編輯',
  'LBL_REMOVE' => '移除',
  'LBL_LIST_FORM_TITLE' => '通用接口-接口批数据 列表',
  'LBL_MODULE_NAME' => '通用接口-接口批数据',
  'LBL_MODULE_TITLE' => '通用接口-接口批数据',
  'LBL_HOMEPAGE_TITLE' => '我的 通用接口-接口批数据',
  'LNK_NEW_RECORD' => '創建 通用接口-接口批数据',
  'LNK_LIST' => '視圖 通用接口-接口批数据',
  'LNK_IMPORT_HAA_INTEGRATION_INTERFACE_HEADERS' => '导入 通用接口-接口批数据',
  'LBL_SEARCH_FORM_TITLE' => '搜索 通用接口-接口批数据',
  ...
  'LBL_NEW_FORM_TITLE' => '新建 通用接口-接口批数据',
);