 ...
 */
require_once('modules/HAA_UOM/HAA_UOM_sugar.php');
class HAA_UOM extends HAA_UOM_sugar {
...
/*	function get_list_view_data(){
	...
	//or refer to the asset module as the first customzation module with this feature
		...
		$UOM_fields = $this->get_list_view_array();

		if (!empty($this->conversion))
			$UOM_fields['CONVERSION_TEXT'] = "=2".$this->conversion."* base UOM";
