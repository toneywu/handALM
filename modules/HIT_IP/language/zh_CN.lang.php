...
$mod_strings = array (
  ...
  'LBL_LIST_NAME' => 'IP地址 列表',
  'LBL_EDIT_BUTTON' => '编辑',
  'LBL_REMOVE' => '移除',
  'LBL_LIST_FORM_TITLE' => 'IP地址 列表',
  'LBL_MODULE_NAME' => 'IP地址',
  'LBL_MODULE_TITLE' => 'IP地址',
  'LBL_HOMEPAGE_TITLE' => '我的 IP地址',
  'LNK_NEW_RECORD' => '创建 IP地址',
  'LNK_LIST' => '查看 IP地址',
  'LNK_IMPORT_HIT_IP' => '导入IP地址（C类）',
  'LNK_IMPORT_HIT_SUBNET' => '导入IP地址（子网段）',
  'LBL_SEARCH_FORM_TITLE' => '查找 IP地址',
  'LBL_HISTORY_SUBPANEL_TITLE' => '历史',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => '销售活动',
  'LBL_HIT_IP_SUBPANEL_TITLE' => 'IP地址',
  'LBL_NEW_FORM_TITLE' => '新建 IP地址',
  'LBL_IP_C' => 'IP地址 C',
