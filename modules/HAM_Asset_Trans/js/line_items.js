...
function getnowtime() {//TODO 和hit_ip_trans中的一样，移动到公共函数库
  ...
  //add by liu
  function inactiveUsingAllLine(){
    console.log("inactiveUsingAllLine");
    ...
    /*if($("#all_inactive_using").is(':checked')){
      console.log("checked");
      $("#lineItems tbody").find(":checkbox").attr("checked",true);
      $("#lineItems tbody").find(":checkbox").val('1');
      $("#lineItems tbody").find(":checkbox").parent().next().next().find("input").val(getnowtime());
    }else{
      console.log("unchecked");
      $("#lineItems tbody").find(":checkbox").removeAttr("checked");
      $("#lineItems tbody").find(":checkbox").val('0');
      $("#lineItems tbody").find(":checkbox").parent().next().next().find("input").val("");
    }*/
