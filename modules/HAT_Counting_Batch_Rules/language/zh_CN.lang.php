...
$mod_strings = array (
  ...
  'LBL_EDIT_BUTTON' => '编辑',
  'LBL_REMOVE' => '移除',
  'LBL_LIST_FORM_TITLE' => '盘点批规则 列表',
  'LBL_MODULE_NAME' => '盘点批规则',
  'LBL_MODULE_TITLE' => '盘点批规则',
  'LBL_HOMEPAGE_TITLE' => '我的 盘点批规则',
  'LNK_NEW_RECORD' => '创建 盘点批规则',
  'LNK_LIST' => '查看 盘点批规则',
  'LNK_IMPORT_HAT_COUNTING_BATCH_RULES' => '导入 盘点批规则',
  'LBL_SEARCH_FORM_TITLE' => '查找 盘点批规则',
  'LBL_HISTORY_SUBPANEL_TITLE' => '历史',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => '销售活动',
  'LBL_HAT_COUNTING_BATCH_RULES_SUBPANEL_TITLE' => '盘点批规则',
  'LBL_NEW_FORM_TITLE' => '新建 盘点批规则',
  'LBL_ORG_SPLIT_FLAG' => '部门',
  'LBL_LOC_SPLIT_FLAG' => '地点',
  'LBL_MAJOR_SPLIT_FLAG' => '专业',
  'LBL_CATEGORY_SPLIT_FLAG' => '类别',
  'LBL_LOCATION_HAT_ASSET_LOCATIONS_ID' => '位置 (related 位置 ID)',
  'LBL_LOCATION' => '位置',
  ...
  'LBL_CATEGORY_AOS_PRODUCT_CATEGORIES_ID' => '类别 (related  ID)',
  'LBL_CATEGORY' => '类别',
  'LBL_CATEGORY_DRILLDOWN' => '包括子类别',
  'LBL_COUNTING_RULE_HAT_COUNTING_RULES_ID' => '任务拆分方式 (related  ID)',
