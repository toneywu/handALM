...
$dictionary['HAT_Counting_Batch_Rules'] = array(
    ...
    'fields'=>array (
      ...
      array (
        'required' => false,
        'name' => 'account_id_c1',
        'vname' => 'LBL_using_organization_ACCOUNT_ID',
        'type' => 'id',
        'massupdate' => 0,
        'no_default' => false,
        'comments' => '',
      ...
      array (
        ...
        'vname' => 'LBL_COUNTING_POLICIES_HAT_COUNTING_POLICIES_ID',
        'type' => 'id',
        'massupdate' => 0,
        'no_default' => false,
        'comments' => '',
