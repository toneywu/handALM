...
<div id="HAM_Work_Center_Res_detailview_tabs"
>
<div >
...
{capture name="label" assign="label"}{sugar_translate label='LBL_NAME' module='HAM_Work_Center_Res'}{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='HAM_Work_Center_Res'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DATE_ENTERED' module='HAM_Work_Center_Res'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DATE_MODIFIED' module='HAM_Work_Center_Res'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DESCRIPTION' module='HAM_Work_Center_Res'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
