...
$dictionary['HAM_Work_Center_Res'] = array(
	'table'=>'ham_work_center_res',
	'audited'=>true,
    'inline_edit'=>true,
...
'ham_work_center_name' => 
  array (
    ...
    'vname' => 'LBL_HAM_WORK_CENTER_NAME',
    'type' => 'relate',
    'massupdate' => 0,
    'no_default' => false,
    'comments' => '',
  ...
  'work_center_res_people_link' =>
      array(
        'name' => 'work_center_res_people_link',
        'type' => 'link',
        'relationship' => 'ham_work_center_res_people',
...
VardefManager::createVardef('HAM_Work_Center_Res','HAM_Work_Center_Res', array('basic','assignable','security_groups'));