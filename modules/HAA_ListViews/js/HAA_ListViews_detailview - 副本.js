...
$(document).ready(function(){
	...
	/*$("#sort_column1").after($("#sort_column1").val());
	$("#sort_column2").after($("#sort_column2").val());
	$("#sort_column3").after($("#sort_column3").val());
	$("#sort_column4").after($("#sort_column4").val());*/
	$("#s_sort_column1").hide();
	$("#s_sort_column2").hide();
	$("#s_sort_column3").hide();
    ...
    function GenerateDoc() {
		...
		var $html=$(html);
		/*var html='<select id="window_type_list" class="window_type_list" name="window_type_list">'+
		list+'</select>';*/
