...
$mod_strings = array (
  ...
  'LBL_EDIT_BUTTON' => '编辑',
  'LBL_REMOVE' => '移除',
  'LBL_LIST_FORM_TITLE' => 'SSO配置 列表',
  'LBL_MODULE_NAME' => 'SSO配置',
  'LBL_MODULE_TITLE' => 'SSO配置',
  'LBL_HOMEPAGE_TITLE' => '我的 SSO配置',
  'LNK_NEW_RECORD' => '创建 SSO配置',
  'LNK_LIST' => '查看 SSO配置',
  'LNK_IMPORT_HAA_SSOSETS' => '导入 SSO配置',
  'LBL_SEARCH_FORM_TITLE' => '查找 SSO配置',
  'LBL_HISTORY_SUBPANEL_TITLE' => '历史',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => '销售活动',
  'LBL_HAA_SSOSETS_SUBPANEL_TITLE' => 'SSO配置',
  'LBL_NEW_FORM_TITLE' => '新建 SSO配置',
  'LBL_FRAMEWORKS_HAA_FRAMEWORKS_ID' => '业务框架 (related Business Framework ID)',
  'LBL_FRAMEWORKS' => '业务框架',
  'LBL_SSO_CODE' => 'SSO代码',
  'LBL_SSO_SYSTEM_HAA_CODES_ID' => '认证系统 (related 列表代码 ID)',
  'LBL_SSO_SYSTEM' => '认证系统',
  'LBL_CERTIFICATE_KEY' => '凭证关键字',
  'LBL_SSO_URL' => 'SSO URL',
  'LBL_DEFAULT_LOGIN_URL' => '默认登录URL',
  'LBL_HTTP_REFERER_URL' => '代理URL',
  'LBL_ENABLED_FLAG' => '是否启用',
  'LBL_KEYWORD1' => 'Keyword1',
  'LBL_KEYWORD2' => 'keyword2',
  'LBL_KEYWORD3' => 'keyword3',
  'LBL_KEYWORD4' => 'keyword4',
