...
$dictionary['HAT_Counting_Rule_Dtls'] = array(
	'table'=>'hat_counting_rule_dtls',
	'audited'=>true,
    'inline_edit'=>true,
  ...
  array (
    'required' => false,
    'name' => 'haa_codes_id_c',
    'vname' => 'LBL_COUNTING_OBJ_TYPE_HAA_CODES_ID',
    'type' => 'id',
    'massupdate' => 0,
    'no_default' => false,
    'comments' => '',
  ...
  array (
    ...
    'len' => 100,
    'size' => '20',
    'options' => 'hat_counting_split_accord',
    'studio' => 'visible',
    'dependency' => false,
  ),
  'additional_comment' => 
...
VardefManager::createVardef('HAT_Counting_Rule_Dtls','HAT_Counting_Rule_Dtls', array('basic','assignable','security_groups'));
