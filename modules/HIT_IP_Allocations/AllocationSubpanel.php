...
function get_ip_allocation($params) {
    ...
    $return_array['where'] = " WHERE hit_ip_allocations.hit_ip_trans_batch_id = hit_ip_trans_batch.id and hit_ip_allocations.target_owning_org_id='" . $using_org_id . "'"." AND hit_ip_allocations.enable_action = 1";//会自动加入deleted字段
