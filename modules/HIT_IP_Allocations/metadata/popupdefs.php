...
'whereStatement'=>'IFNULL(hit_ip_allocations.status,"EFFECTIVE")="EFFECTIVE" and  (jt1.name="'.$_REQUEST["access_assets_name_advanced"].'" or jt2.name="'.$_REQUEST["access_assets_name_advanced"].'" or "'.$_REQUEST["access_assets_name_advanced"].'"="" ) OR  (jt2.name LIKE "'.$_REQUEST["access_assets_name_advanced"].'%" AND IFNULL(hit_ip_allocations.status,"EFFECTIVE") = "EFFECTIVE") ',
    'searchInputs' => array (
  4 => 'hit_ip_subnets',
  5 => 'bandwidth_type',
  6 => 'cabinet',
