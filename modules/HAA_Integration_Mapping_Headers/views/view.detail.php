...
class HAA_Integration_Mapping_HeadersViewDetail extends ViewDetail
{
    ...
    function Display() {
        ...
        //0.处理头与行的语言包
        $modules = array('HAA_Integration_Mapping_Headers', 'HAA_Integration_Mapping_Lines'
            );
       ...
       /*if (isset ($this->bean->hat_eventtype_id) && ($this->bean->hat_eventtype_id) != "") {
        ...
        //设置权限
        if(!(ACLController::checkAccess('HAA_Integration_Mapping_Lines', 'detail', true))){
