...
/*        foreach ($_REQUEST['field_to_name_array'] as $key => $value) {
            echo $key.":".$value;
        }*/
        //for $_REQUEST['field_to_name'];
    	echo '</form>';

//
//{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"hat_event_type_id","name":"event_type"}}
