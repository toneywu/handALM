...
function GenerateDoc() {
	if (typeof template_id == 'undefined' || template_id.length == 0) {
		...
		var $html=$('<select id="pdf_template_list" name="pdf_template_list">'+
			list+'</select>');
