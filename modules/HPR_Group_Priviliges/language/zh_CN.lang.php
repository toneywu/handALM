...
$mod_strings = array (
  ...
  'LBL_EDIT_BUTTON' => '编辑',
  'LBL_REMOVE' => '移除',
  'LBL_LIST_FORM_TITLE' => '权限策略 列表',
  'LBL_MODULE_NAME' => '权限策略',
  'LBL_MODULE_TITLE' => '权限策略',
  'LBL_HOMEPAGE_TITLE' => '我的 权限策略',
  'LNK_NEW_RECORD' => '创建 权限策略',
  'LNK_LIST' => '查看 权限策略',
  'LNK_IMPORT_HPR_GROUP_PRIVILIGES' => '导入 权限策略',
  'LBL_SEARCH_FORM_TITLE' => '查找 权限策略',
  'LBL_HISTORY_SUBPANEL_TITLE' => '历史',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => '销售活动',
  'LBL_HPR_GROUP_PRIVILIGES_SUBPANEL_TITLE' => '权限策略',
  'LBL_NEW_FORM_TITLE' => '新建 权限策略',
  'LBL_MODULE' => '模块',
  'LBL_SQL_STATEMENT_FOR_LISTVIEW' => 'SQL Statement For ListView',
  ...
  'LBL_POPUP_GLOBAL_FLAG' => 'POPUP全局适用',
);