...
class Attr_Replace
{
	...
	*/
	...
	function setLov($field_info){
		...
		$return_html="<td style='vertical-align: middle;'><input name='".$lov_name."' class='sqsEnabled yui-ac-input' tabindex='0' id='".$field_info["prefix"].$field_info["column_name"]."_name".$field_info["prodln"]."' size='' value='".$row_name."' title='' autocomplete='off' accesskey='7' type='text'";
		$return_html.=$field_info['can_edit_flag']==0?"disabled='disabled'":"";
