 ...
 */
require_once('modules/HAA_Integration_System_Def_Headers/HAA_Integration_System_Def_Headers_sugar.php');
class HAA_Integration_System_Def_Headers extends HAA_Integration_System_Def_Headers_sugar {
	...
	function get_list_view_data(){
		...
		if ($bean_interface) {
			$fields['LINK_SYSTEM'] = $this->link_system=isset($bean_interface->link_system)?$bean_interface->link_system:''; 
	...
	function save($check_notify = FALSE){
        ...
        for ($i = 0; $i < $line_count; ++$i) {
        	$lines = new HAA_Integration_System_Def_Lines();
