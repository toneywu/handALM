 ...
 */
require_once('modules/HAT_Counting_Policy_Groups/HAT_Counting_Policy_Groups_sugar.php');
class HAT_Counting_Policy_Groups extends HAT_Counting_Policy_Groups_sugar {
...
function save($check_notify = FALSE){
        ...
        for ($i = 0; $i < $line_count; ++$i) {
        	$key="line_";
        	$lines = new HAT_Counting_Policies();
            if ($post_data[$key . 'deleted'][$i] == 1) {
	            ...
	            if (!$post_data['line_id'][$i]) {//新建才加关联关系
	            	...
	            	$relate_values = array(
            		'deleted' =>0 ,
	            	'hat_counti1658_groups_ida'=>$this->id,
	            	'hat_counti9da1olicies_idb'=>$lines->id 
	            	);
	            }
