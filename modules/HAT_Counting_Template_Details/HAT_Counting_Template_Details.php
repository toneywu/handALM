 ...
 */
require_once('modules/HAT_Counting_Template_Details/HAT_Counting_Template_Details_sugar.php');
class HAT_Counting_Template_Details extends HAT_Counting_Template_Details_sugar {
	
	function __construct(){
		parent::__construct();
	}
	
	/*function save_line($post_data,$key,$hid){
