...
$lines_bean = BeanFactory::getBean('HAM_WO_Lines')->get_full_list('name',"ham_wo_lines.ham_wo_id is not null and ham_wo_lines.ham_wo_id!='' and ham_wo_lines.ham_wo_id='".$current_id."'");
...
//新增 by liu
echo '<th>'.translate('LBL_DESCRIPTION','HAM_WO_Lines').'</th>';
echo '</tr>';
if (isset($lines_bean)) {
    foreach ($lines_bean as $thisLine) {
        ...
        echo '<td>'.$thisLine->description.'</td>';
       	echo '</tr>';
    }
} else {
