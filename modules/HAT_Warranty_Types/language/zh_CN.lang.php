...
$mod_strings = array (
  ...
  'LBL_EDIT_BUTTON' => '编辑',
  'LBL_REMOVE' => '移除',
  'LBL_LIST_FORM_TITLE' => '质保类型 列表',
  'LBL_MODULE_NAME' => '质保类型',
  'LBL_MODULE_TITLE' => '质保类型',
  'LBL_HOMEPAGE_TITLE' => '我的 质保类型',
  'LNK_NEW_RECORD' => '创建 质保类型',
  'LNK_LIST' => '查看 质保类型',
  'LNK_IMPORT_HAT_WARRANTY_TYPES' => '导入 质保类型',
  'LBL_SEARCH_FORM_TITLE' => '查找 质保类型',
  'LBL_HISTORY_SUBPANEL_TITLE' => '历史',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => '销售活动',
  'LBL_HAT_WARRANTY_TYPES_SUBPANEL_TITLE' => '质保类型',
  'LBL_NEW_FORM_TITLE' => '新建 质保类型',
  'LBL_DOMAIN'=>'运营区域'
);