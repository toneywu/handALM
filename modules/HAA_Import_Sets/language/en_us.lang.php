...
$mod_strings = array (
  ...
  'LBL_REMOVE' => 'Remove',
  'LBL_LIST_FORM_TITLE' => '通用导入设置 List',
  'LBL_MODULE_NAME' => '通用导入设置',
  'LBL_MODULE_TITLE' => '通用导入设置',
  'LBL_HOMEPAGE_TITLE' => 'My 通用导入设置',
  'LNK_NEW_RECORD' => 'Create 通用导入设置',
  'LNK_LIST' => 'View 通用导入设置',
  'LNK_IMPORT_HAA_IMPORT_SETS' => '导入 通用导入设置',
  'LBL_SEARCH_FORM_TITLE' => 'Search 通用导入设置',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'View History',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Activities',
  'LBL_HAA_IMPORT_SETS_SUBPANEL_TITLE' => '通用导入设置',
  'LBL_NEW_FORM_TITLE' => 'New 通用导入设置',
