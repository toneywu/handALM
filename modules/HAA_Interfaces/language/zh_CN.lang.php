...
$mod_strings = array (
  ...
  'LBL_EDIT_BUTTON' => '编辑',
  'LBL_REMOVE' => '移除',
  'LBL_LIST_FORM_TITLE' => '接口管理 列表',
  'LBL_MODULE_NAME' => '接口管理',
  'LBL_MODULE_TITLE' => '接口管理',
  'LBL_HOMEPAGE_TITLE' => '我的 接口管理',
  'LNK_NEW_RECORD' => '创建 接口管理',
  'LNK_LIST' => '查看 接口管理',
  'LNK_IMPORT_HAA_INTERFACES' => '导入 接口管理',
  'LBL_SEARCH_FORM_TITLE' => '查找 接口管理',
  'LBL_HISTORY_SUBPANEL_TITLE' => '历史',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => '销售活动',
  'LBL_HAA_INTERFACES_SUBPANEL_TITLE' => '接口管理',
  'LBL_NEW_FORM_TITLE' => '新建 接口管理',
  'LBL_FRAMEWORKS_HAA_FRAMEWORKS_ID' => '业务框架 (related Business Framework ID)',
  'LBL_FRAMEWORKS' => '业务框架',
  'LBL_INTERFACE_CODE' => '接口代码',
  'LBL_LINK_SYSTEM_HAA_CODES_ID' => '对接系统 (related 列表代码 ID)',
  'LBL_LINK_SYSTEM' => '对接系统',
  'LBL_INTERFACE_TYPE' => '接口类型',
  'LBL_OWN_MODULE' => '归属模块',
  'LBL_ENABLED_FLAG' => '是否启用',
  'LBL_AUTH_USER_NAME' => '认证用户',
  'LBL_AUTH_KEY' => '认证密钥',
