 ...
 */
 ...
 function insertProductLine(tableid, groupid) {
    var l_group_name=document.getElementById("group"+(groupn-1)+"name");
    var l_group_id=document.getElementById("group"+(groupn-1)+"id")
    if(!l_group_id.value){
    if(!l_group_name.value){
        return false;
    }
}
    var curent_module=GetUrlParamString("module");
    ...
    /*if(curent_module=="HAOS_Contract_Templates"){*/
 ...
 */
 ...
 function insertProductHeader(tableid){
    ...
    /*if (curent_module=="HAOS_Contract_Templates") {*/
        a1.innerHTML=SUGAR.language.get('HAOS_Contract_Templates', 'LBL_UOM_NAME_C');
    //}
 ...
 */
 ...
 if(enable_groups){
    ...
    header_cell.innerHTML=SUGAR.language.get(module_sugar_grp1, 'LBL_GROUP_NAME')+
    ":&nbsp;&nbsp;<input class='sqsEnabled yui-ac-input autocomplete='off' type='text' name='group_name["+groupn+"]' id='"+ table.id +"name' size='30' maxlength='255' autocomplete='off' title='' tabindex='120' readonly='true'>"+
    ...
    "<input type='hidden' name='group_name_id["+groupn+"]' id='"+ table.id +"name_id' value=''>";
    ...
    addToValidate('EditView', table.id +'name','varchar', true,'Please choose a group name');
    //alert(table.id);
}
 ...
 */
 ...
 function markLineDeleted(ln, key)
 {
    ...
    if(checkValidate('EditView',key+'product_id' +ln)){
        ...
        removeFromValidate('EditView','group' +ln+'name');
    }
