...
{if !$fields.map_file.hidden}
{counter name="panelFieldCount"}
<span id="map_file" class="sugar_field"><input type="hidden" value="{$fields.map_file.value}" id="map_url".><div id="cuxMap" style="background-color: #efefef; height: 20px; width: 80%;">map will be loaded here</div></span>
{/if}
</td>
</tr>
{/capture}
