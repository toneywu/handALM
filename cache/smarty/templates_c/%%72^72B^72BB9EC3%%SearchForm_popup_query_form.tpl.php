<?php /* Smarty version 2.6.29, created on 2016-08-23 14:15:28
         compiled from cache/modules/HAA_Frameworks/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/HAA_Frameworks/SearchForm_popup_query_form.tpl', 26, false),array('function', 'math', 'cache/modules/HAA_Frameworks/SearchForm_popup_query_form.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/HAA_Frameworks/SearchForm_popup_query_form.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/HAA_Frameworks/SearchForm_popup_query_form.tpl', 44, false),array('function', 'sugar_getimage', 'cache/modules/HAA_Frameworks/SearchForm_popup_query_form.tpl', 69, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'HAA_Frameworks'), $this);?>
</label>
		</td>
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'popup_query_form_modified_by_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_created_by_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_assigned_user_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_default_product_uom_advanced\']={"form":"popup_query_form","method":"query","modules":["HAA_UOM"],"group":"or","field_list":["name","id"],"populate_list":["default_product_uom_advanced","default_product_uom_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_default_area_uom_class_advanced\']={"form":"popup_query_form","method":"query","modules":["HAA_UOM_Classes"],"group":"or","field_list":["name","id"],"populate_list":["default_area_uom_class_advanced","default_area_uom_class_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_default_time_uom_class_advanced\']={"form":"popup_query_form","method":"query","modules":["HAA_UOM_Classes"],"group":"or","field_list":["name","id"],"populate_list":["default_time_uom_class_advanced","default_time_uom_class_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_asset_numbering_rule_advanced\']={"form":"popup_query_form","method":"query","modules":["HAA_Numbering_Rule"],"group":"or","field_list":["name","id"],"populate_list":["asset_numbering_rule_advanced","haa_asset_numbering_rule_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_at_numbering_rule_advanced\']={"form":"popup_query_form","method":"query","modules":["HAA_Numbering_Rule"],"group":"or","field_list":["name","id"],"populate_list":["at_numbering_rule_advanced","haa_at_numbering_rule_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>