...
class HAT_DomainDashlet extends DashletGeneric { 
    function __construct($id, $def = null) {
        ...
        $this->searchFields = $dashletData['HAT_DomainDashlet']['searchFields'];
        $this->columns = $dashletData['HAT_DomainDashlet']['columns'];
