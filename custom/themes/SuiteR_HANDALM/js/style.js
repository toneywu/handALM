...
function loadSidebar() { //upgraded by version7.7.8 SuiteP Theme
    if($('#sidebar_container').length) {

        $('#buttontoggle').unbind('click').bind('click', function (e) {
            //not sure why the click will be trigered twice, so unbind firstly
            $('.sidebar').toggle();
