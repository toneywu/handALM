 ...
 function insertLineItems(product,group){
    ...
    for(var p in product){
        if(document.getElementById(type + p + ln) !== null){
            ...
            if (curent_module=='HAOS_Contract_Templates'&&p=='settlement_period_c') {
                if (type=='product_'){
            ...
            if (curent_module=='HAOS_Contract_Templates'&&p=='number_of_periods_c') {
 ...
 */
 function openProductPopup(ln){
    ...
    var condition = '&contract_flag_c=1';
...
{
    return 'HAOS_Contract_Templates';
}
